...
-   `summary`: (String) สรุปใจความสำคัญทั้งหมดของเอกสารให้กระชับและครอบคลุมที่สุด ภายใน 1-3 ประโยค
...
-   `details`: (Array of Objects) สกัดเนื้อหาโดยละเอียดตามโครงสร้างหัวข้อในเอกสารต้นฉบับ
    ...
    -   `content`: (String) เนื้อหาทั้งหมดภายใต้หัวข้อย่อยนั้นๆ โดยไม่มีการตัดทอนหรือเปลี่ยนแปลง
...
3.  เนื้อหาใน `details.content` ต้องเป็นการคัดลอกมาทั้งหมด ห้ามสรุปย่อเด็ดขาด
4.  หากเอกสารไม่มีหัวข้อย่อยที่ชัดเจน ให้ใช้ `heading` ใน `details` เพียงอันเดียว โดยตั้งชื่อว่า "ภาพรวม" และใส่เนื้อหาทั้งหมดลงใน `content`
