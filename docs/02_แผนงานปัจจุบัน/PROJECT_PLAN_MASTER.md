...
*   [x] ปรับจูน Prompt RAG ให้แม่นยำขึ้น (ลดอาการ Hallucination ด้วย Self-Correction Framework)
...
*   [ ] จัดทำคู่มือผู้ใช้ (User Manual) และคู่มือแอดมิน
*   [ ] แผนการ Backup ข้อมูลรายวัน
