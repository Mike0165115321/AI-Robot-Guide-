...
ระบบใช้สถาปัตยกรรมแบบ **Hybrid Intelligence Optimization** ที่แบ่งการทำงานระหว่าง Frontend (Edge Computing) และ Backend (Cloud AI) เพื่อความเร็วสูงสุดและลดค่าใช้จ่าย
- **Frontend (The Body & Instinct):** มีสมองส่วนหน้า (Frontend Director) สำหรับตัดสินใจเรื่องง่ายๆ, ควบคุมท่าทาง, และจัดการ Real-time Inputs
- **Backend (The Deep Brain):** ประมวลผลเรื่องซับซ้อน, RAG, และจัดการข้อมูลมหาศาล
