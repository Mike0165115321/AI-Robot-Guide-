...
* **Admin Panel:** หน้าสำหรับแอดมินเพื่อจัดการฐานข้อมูล
  * 📊 **Google Sheets Sync:** ซิงค์ข้อมูลจาก Google Sheets เข้าสู่ระบบอัตโนมัติ
  * ⚙️ **Dynamic Field Visibility:** เลือกแสดง/ซ่อน columns ในตารางได้ตามต้องการ
  * 📗 **Sheets Badge:** แสดง indicator สำหรับข้อมูลที่ sync มาจาก Google Sheets
